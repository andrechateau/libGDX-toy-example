...
/**
 * Created by dendem on 16/11/2017.
 */
...
public class Player extends Sprite implements InputProcessor {
    ...
    private Animation<Texture> still, left, right;
    private TiledMapTileLayer collisionLayer;

    private String blockedKey = "blocked";

    public Player(Animation<Texture> still, Animation left, Animation right, TiledMapTileLayer collisionLayer) {
